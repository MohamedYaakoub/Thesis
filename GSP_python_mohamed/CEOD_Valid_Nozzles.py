...
splines = False  # This to activate splines
...
def simulate(Re, inputDat, X):
    ...
    Re2_i, Re25_i, Re3_i, Re4_i, Re49_i, Re5_i, Re14_i, Re19_i, Re6_i, Re9_i = Re.T
...
def run_validation(GEnx_OD, GEnx_OD_true, All_Reynolds):
    ...
    for i, j, k in zip(GEnx_OD, GEnx_OD_true, All_Reynolds):
        ...
        mean, change, validation_params, Reynolds, PRs, ETAs, Ws, TR, FN, Tt, Pt, Nc = compute_error(inputDat, trueVal,
                                                                                                     Re,
                                                                                                     X)
