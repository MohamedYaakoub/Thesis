...
Settings = [[5.1, 2.7, 1.7, 13], [5.1, 2.7, 1.7, 13.1], [5.1, 2.7, 1.71, 13], [5.11, 2.7, 1.7, 13], [5.1, 2.71, 1.7, 13]]

# %%
# Ordered inputs as expected by GSP, only change when changing API block in GSP
InputList = ["BPR", "FPRc", "FPRbp", "HPCpr"]

# Ordered output list as output by GSP, only change when changing API block in GSP

OutputList = ["PS25", "TT25", "Ps14", "Ps3", "TT3", "TT49", "FN"]
...
N_MACHINES = 2  # Number of clients expected
